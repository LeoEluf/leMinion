...
#work
execute if score #items leMinions.temp <= #max_storage leMinions.temp run function le_minions:minions/can_work

#display storage full
execute unless data entity @s data.leMinions.display.storage_full if score #items leMinions.temp > #max_storage leMinions.temp run function le_minions:minions/storage/full
execute if data entity @s data.leMinions.display.storage_full if score #items leMinions.temp <= #max_storage leMinions.temp run function le_minions:minions/storage/not_full
